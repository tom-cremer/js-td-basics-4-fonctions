...
Cette fonction retourne l'âge de la personne en calculant l'année courante moins son année de naissance
*/
...
Cette fonction
	...
	- si ce nombre est positif, elle affiche "… prendra sa pension dans … ans", sinon elle affiche "… est déjà pensionné(e)"
Utiliser ensuite la fonction pour calculer dasn cobiend'années seront pensionnés
	- John (né en 1990)
	- Mike (né en 1948)
	- Jane (née en 1969)
*/
